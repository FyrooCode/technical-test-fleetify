...
export const Step1FormUI: React.FC<Step1FormUIProps> = ({ formData, onSubmit, onInputChange }) => {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => onInputChange('sender_address', e.target.value)}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onInputChange('receiver_name', e.target.value)}
                className={inputClass}
                required
              />
            </div>
            <div>
              ...
              <textarea
                ...
                onChange={(e) => onInputChange('receiver_address', e.target.value)}
                className={`${inputClass} min-h-[100px]`}
                required
              />
            </div>
